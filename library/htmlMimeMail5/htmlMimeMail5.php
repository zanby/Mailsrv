...
class htmlMimeMail5
{
    ...
    */
    ...
    {
        $embeddedImage->cid = (isset($embeddedImage->cid)) ? $embeddedImage->cid : md5(uniqid(time()));
...
class fileEmbeddedImage extends fileAttachment
{
    ...
    * @param string $encoding    What encoding to use
    */
    public function __construct($filename, $contentType = 'application/octet-stream', $encoding = null, $cid = null)
    {
        $this->cid = $cid;
        parent::__construct(file_get_contents($filename), basename($filename), $contentType, $encoding);
    }
...
class stringEmbeddedImage extends stringAttachment
{
    ...
    * @param string $encoding    What encoding to use
    */
    public function __construct($data, $name = '', $contentType = 'application/octet-stream', $encoding = null, $cid = null)
    {
        $this->cid = $cid;
        parent::__construct($data, $name, $contentType, $encoding);
    }
