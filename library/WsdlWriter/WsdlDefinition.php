...
class WsdlDefinition
{
    ...
    private $baseUrl;
     ...
     /**
     * Get the value of classFilePath
     *
     * @return string The value of classFilePath
     */
    ...
    /**
     * Set the value of classFilePath
     *
     * @param string $classFilePath The value of classFilePath
     */
