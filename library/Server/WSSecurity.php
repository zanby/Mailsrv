...
class Server_WSSecurity
{
    ...
    public function setUsernameToken(Server_WSSecurity_UsernameToken $usernameToken)
    {
    ...
    public function __construct($doc) { 
        ...
        $this->SOAPXPath->registerNamespace('wswsu', Server_WSSecurity::WSUNS);
    ...
    protected function processSignature($refNode) {
        ...
        $objXMLSecDSig->idNS['wswsu'] = Server_WSSecurity::WSUNS;
