...
class Server_WSSecurity_Bootstrap_UsernameToken extends Server_WSSecurity_UsernameToken
{
    ...
    {        
        ...
        $select_sql = "SELECT password FROM mail_accounts WHERE username = :username AND status = 'active' AND is_system = 1";
